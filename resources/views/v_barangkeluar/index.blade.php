            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <a href="{{ route('barangkeluar.create') }}" class="btn btn-md btn-success mb-3">TAMBAH BARANG MASUK</a>
                        <form class="form-inline" action="{{ route('barangkeluar.index') }}" method="GET">
