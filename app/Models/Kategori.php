...
class Kategori extends Model
{
    ...
    public static function katShowAll()
    {
        return DB::table('kategori')
            ...
            ->select('kategori.id', 'deskripsi', DB::raw('ketKategori(deskripsi) as ketkategori'), 'barang.merk')
            ->get();
    }
    ...
    public static function showKategoriById($id)
    {
        return DB::table('kategori')
            ->join('barang', 'kategori.id', '=', 'barang.kategori_id')
            ->select('barang.id', 'kategori.deskripsi', DB::raw('ketKategori(kategori.deskripsi) as ketkategori'), 'barang.merk', 'barang.seri', 'barang.spesifikasi', 'barang.stok')
            ->get();
    }
}
